            ...
            <input type="checkbox" id="chk" aria-hidden="true">
                <div class="signup">
                    <form>
                        ...
                        <input type="text" v-model="registration.firstName" name="txt" placeholder="Имя" required>
                        <input type="email" v-model="registration.email" name="email" placeholder="Email" required>
                        <input type="password" v-model="registration.password" name="pswd" placeholder="Пароль" required>
                        <input type="password" v-model="registration.passwordConfirm" name="pswd" placeholder="Повторите пароль" required>
                        <button @click.prevent="registr">Зарегистрироваться</button>
                        <router-link :to="{name: 'Index'}" class="go-back">Вернуться назад</router-link>
                    </form>
                </div>
                <div class="login">
                    <form>
                        <label for="chk" aria-hidden="true">Авторизация</label>
                        <input type="email" v-model="login.email" name="email" placeholder="Email" required="">
                        <input type="password" v-model="login.password" name="pswd" placeholder="Password" required="">
